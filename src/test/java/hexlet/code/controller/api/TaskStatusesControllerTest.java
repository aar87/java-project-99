...
import hexlet.code.utils.DataGenerator;
...
public class TaskStatusesControllerTest {
    ...
    public void setUp() {
        ...
        testStatus = DataGenerator.getTaskStatus();
    }
    ...
    public void testGetById() throws Exception {
        ...
        assertThatJson(body).and(
                ...
                v -> v.node("createdAt").asString().contains(testStatus.getCreatedAt().toString())
        );
    }

    @Test
    public void testCreate() throws Exception {
        TaskStatusCreateDTO dto = new TaskStatusCreateDTO(testStatus.getName(), testStatus.getSlug());
    ...
    public void testCreateWithNotValidSlug() throws Exception {
        TaskStatusCreateDTO dto = new TaskStatusCreateDTO(testStatus.getName(), "");
    ...
    public void testPartialUpdate() throws Exception {
        ...
        dto.put("name", "Updated name from partial");
