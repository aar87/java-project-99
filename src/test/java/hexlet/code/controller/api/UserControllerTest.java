...
public class UserControllerTest {
    ...
    public void testGetById() throws Exception {
        ...
        assertThatJson(body).and(
                ...
                v -> v.node("createdAt").asString().contains(testUser.getCreatedAt().toString())
        );
    }
    ...
    public void testCreateWithNotValidEmail() throws Exception {
        ...
        dto.setEmail("invalidemailtottest.");
    ...
    public void testPartialUpdate() throws Exception {
        ...
        dto.put("firstName", "Partial updated firstname");
    ...
    public void testDeleteWithoutAuth() throws Exception {
        userRepository.save(testUser);
        User testUser2 = DataGenerator.getUser();
