...
public class TaskControllerTest {
    ...
    public void setUp() {
        ...
        testUser = DataGenerator.getUser();
        userRepository.save(testUser);

        testStatus = DataGenerator.getTaskStatus();
        statusRepository.save(testStatus);

        testLabel = DataGenerator.getLabel();
        labelRepository.save(testLabel);

        testTask = DataGenerator.getTask();
    ...
    public void testGetAllWithFilter() throws Exception {
        Task testTask2 = DataGenerator.getTask();
...
//                v -> v.node("createdAt").asString().contains(testTask.getCreatedAt().toString()),
    ...
    public void testCreate() throws Exception {
        ...
        dto.setAssigneeId(testUser.getId());
        dto.setTaskLabelIds(testTask.getLabels().stream().map(Label::getId).collect(Collectors.toSet()));
    ...
    public void testUpdate() throws Exception {
        ...
        data.setTitle("New title created");
        data.setContent("Content for new title that created");
